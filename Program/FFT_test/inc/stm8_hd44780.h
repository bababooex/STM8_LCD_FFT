...
// define 0only if powering LCD from GPIO (feature for low power applications)
#ifdef USE_POWER_PIN
...
#define LCD_COMMAND_DELAY 30 // us
#define LCD_BUSY_TIMEOUT 10 // maximum attempts to read busy flags
