 ...
 372  0110 4b01          	push	#1
 373  0112 ae5005        	ldw	x,#20485
 ...
 383  011b 4b01          	push	#1
 384  011d ae5005        	ldw	x,#20485
 ...
 800  01d3 4b20          	push	#32
 801  01d5 ae5005        	ldw	x,#20485
 802  01d8 cd0000        	call	_GPIO_WriteHigh
 804  01db 84            	pop	a
 805                     ; 126     delay_ms(2);
 807  01dc ae0002        	ldw	x,#2
 808  01df cd0000        	call	_delay_ms
 810                     ; 127     GPIO_WriteLow(LCD_PORT,LCD_EN);   
 812  01e2 4b20          	push	#32
 813  01e4 ae5005        	ldw	x,#20485
